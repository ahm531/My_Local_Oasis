![docker image](https://github.com/ahm531/nomad_sintering_image/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/ahm531/nomad_sintering_image/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/ahm531/nomad_sintering_image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/ahm531/nomad_sintering_image/manifests/main": unauthorized`
